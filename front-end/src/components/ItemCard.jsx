...
export default function ItemCard({ item }) {
  ...
  return (
    <div className="bg-[#0f172a] rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 flex flex-col h-full max-h-[400px] transform hover:-translate-y-1 w-full md:max-w-[400px] xl:max-w-[550px]">
